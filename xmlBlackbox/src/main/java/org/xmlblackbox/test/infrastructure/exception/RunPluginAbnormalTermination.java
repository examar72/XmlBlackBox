...
public class RunPluginAbnormalTermination extends XmlBlackBoxException {

    private Exception containedException = null;
    protected final static Logger log = Logger.getLogger(RunPluginAbnormalTermination.class);

    /**
     * 
    */
    public RunPluginAbnormalTermination() {
        super();
    }
    ...
    */
     ...
     * 
    */
    public RunPluginAbnormalTermination(String errorMessage, String tagName) {
