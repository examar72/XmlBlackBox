 ...
 * @author examar.xbb
 */
public class ExampleVersion21_003 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion21_003.class);

    public ExampleVersion21_003(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion21_003.class);
        return suite;
    }
