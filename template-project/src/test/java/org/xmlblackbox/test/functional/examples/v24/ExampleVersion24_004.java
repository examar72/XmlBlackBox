 ...
 * @author Crea
 */
public class ExampleVersion24_004 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion24_004.class);

    public ExampleVersion24_004(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion24_004.class);
        return suite;
    }
