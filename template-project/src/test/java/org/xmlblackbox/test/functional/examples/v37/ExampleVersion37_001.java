 ...
 * @author Crea
 */
public class ExampleVersion37_001 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion37_001.class);

    public ExampleVersion37_001(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion37_001.class);
        return suite;
    }
