 ...
 * @author Crea
 */
public class ExampleConte extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleConte.class);

    public ExampleConte(String msg) {
        super(msg);
    }

    public static Test suite() {
    	log.info("Log TestCase ExampleConte");
        TestSuite suite= new TestSuite(ExampleConte.class);
        return suite;
    }
