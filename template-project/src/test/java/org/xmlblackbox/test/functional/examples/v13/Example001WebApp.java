 ...
 * @author Crea
 */
public class Example001WebApp extends FlowControl{
    private final static Logger log = Logger.getLogger(Example001WebApp.class);

    public Example001WebApp(String msg) {
        super(msg);
    }

    public static Test suite() {
    	log.info("Log TestCase Example001WebApp");
        TestSuite suite= new TestSuite(Example001WebApp.class);
        return suite;
    }
