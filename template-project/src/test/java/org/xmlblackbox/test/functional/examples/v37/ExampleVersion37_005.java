 ...
 * @author Crea
 */
public class ExampleVersion37_005 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion37_005.class);

    public ExampleVersion37_005(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion37_005.class);
        return suite;
    }
