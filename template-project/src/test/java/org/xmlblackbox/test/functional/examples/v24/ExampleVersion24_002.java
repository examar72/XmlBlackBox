 ...
 * @author Crea
 */
public class ExampleVersion24_002 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion24_002.class);

    public ExampleVersion24_002(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion24_002.class);
        return suite;
    }
