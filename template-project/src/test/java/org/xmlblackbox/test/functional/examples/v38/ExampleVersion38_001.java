 ...
 * @author Crea
 */
public class ExampleVersion38_001 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion38_001.class);

    public ExampleVersion38_001(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion38_001.class);
        return suite;
    }
