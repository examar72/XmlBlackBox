 ...
 * @author examar.xbb
 */
public class ExampleVersion19_004 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion19_004.class);

    public ExampleVersion19_004(String msg) {
        super(msg);
    }

    public static Test suite() {
        TestSuite suite= new TestSuite(ExampleVersion19_004.class);
        return suite;
    }
    ...
    public void testExecute() {
       	try {
            ...
            assertTrue("The message received is not one expected", 
            		e.getMessage().startsWith("Variable not found : noVar@setVariable"));
   		} catch (Exception e) {
