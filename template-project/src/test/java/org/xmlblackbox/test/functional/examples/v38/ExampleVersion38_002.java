 ...
 * @author Examar
 */
public class ExampleVersion38_002 extends FlowControl{
    private final static Logger log = Logger.getLogger(ExampleVersion38_002.class);

    public ExampleVersion38_002(String msg) {
        super(msg);
    }

    public static Test suite() {
    	log.info("Log TestCase ExampleVersion38_002");
        TestSuite suite= new TestSuite(ExampleVersion38_002.class);
        return suite;
    }
